...
I have studied the effect of female students' drinking habits to final math grade and other variables. Fist of all, my analysis suggests that there's no direct linear association between alocohol consumption and the grade. However, there was a weak evidence that higher alcohol consumption might be protective for getting 0 point in the final grade. This will require further studies to confirm. In addition, those female students that reported going out more with their friends, were in higher risk of drinking more OR = 1.6 (CI95% 1.2 - 2.3, p = 0.001). Furthermore, the analysis suggested that mothers and fathers educational levels might have opposing effect to girls drinking: higher mothers educational level was found to be protective for high alcohol use whereas higher fathers educational level had positive effect. This question should also be addresed in future studies.
